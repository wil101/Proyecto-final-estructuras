...
app.post('/facturacion', (req, res) => {
  ...
  const query = 'INSERT INTO facturacion (medioDePago, valorTotal, fechaPago, idInventario, idBalance) VALUES (?, ?, ?, ?, ?)';
  db.query(query, [medioDePago, valorTotal, fechaPago, idInventario, idBalance], (err, result) => {
    if (err) {
